  const fs = require('fs')
  let _hasilBuruan = JSON.parse(fs.readFileSync('./DatabaseGT/user/hasil_buruan.json'))
  ...
  const addInventoriBuruan = (sender) => {
        ...
        fs.writeFileSync('./DatabaseGT/user/hasil_buruan.json', JSON.stringify(_hasilBuruan))
   }
