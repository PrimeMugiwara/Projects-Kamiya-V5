  const fs = require('fs')
  let _inventoryOrang = JSON.parse(fs.readFileSync('./DatabaseGT/user/inventory.json'))
  ...
  const addInventori = (sender) => {
        ...
        fs.writeFileSync('./DatabaseGT/user/inventory.json', JSON.stringify(_inventoryOrang))
   }
